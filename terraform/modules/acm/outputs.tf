...
output "acm_certificate_record_name" {
    ...
    value =  aws_acm_certificate.ecs.domain_validation_options[0].resource_record_name
  
}

output "acm_certificate_record_type" {
    description = "The record type of the acm certificate"
    value =  aws_acm_certificate.ecs.domain_validation_options[0].resource_record_type
  
}

output "acm_certificate_record_value" {
    description = "The record value of the acm certificate"
    value =  aws_acm_certificate.ecs.domain_validation_options[0].resource_record_value
